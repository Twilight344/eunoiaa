...
// Google OAuth
const GOOGLE_CLIENT_ID = '32274309102-oo62hub7skqpsdnsf9nfl44fe4gls7kk.apps.googleusercontent.com';
...
function Signup() {
  ...
  const handleGoogleSignup = async () => {
    try {
      ...
      // Detect popup close and show error if signup not handled
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-20 right-10 w-32 h-32 border border-white/5 rotate-45"></div>
        <div className="absolute bottom-20 left-10 w-24 h-24 border border-white/5 rounded-full"></div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mt-2">
            <p className="text-xs text-white/40">
              Start your journey to a healthier mind. We're here for you.
            </p>
          </div>
        </div>
      </div>
